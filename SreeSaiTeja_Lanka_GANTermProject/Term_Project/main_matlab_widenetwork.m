...
layers = [
    ...
    convolution2dLayer(5,100,'Padding',[2 2],'Stride', [2,2]);  % convolution layer with 20, 5x5 filters
...
savefig('trainconfusion_wide1.fig')
...
savefig('validationConfusion_wide1.fig')
...
savefig('trainconfusion_wide2.fig')
...
savefig('validationConfusion_wide2.fig')
...
savefig('testConfusion_wide.fig')

figure(6)
plotTrainingAccuracy_All(info1,numEpochs);
savefig('wide_learningrate5.fig')

figure(7)
plotTrainingAccuracy_All(info2,numEpochs);
savefig('wide_learningrate1.fig')

save('widenetwork_output.mat');
